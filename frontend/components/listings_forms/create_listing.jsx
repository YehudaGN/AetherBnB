    ...
    render() {
        ...
        return (
            <form onSubmit={this.handleSubmit}>
                ...
                <input type="number" value = {this.state.zip_code} onChange= {this.handleChange('zip_code')} placeholder = 'Zip Code'/>
                <input type="number" value = {this.state.num_beds} onChange= {this.handleChange('num_beds')} placeholder = 'Number of Beds'/>
